...
const char* ssid = "Fernando e Isa";          // troque pelo nome da sua rede
const char* password = "P@ssw0rdF3r3Is@";     // troque pela senha da sua rede
WiFiClient nodemcuClient;

// --- MQTT ---
#include <PubSubClient.h>
const char* mqtt_Broker = "iot.eclipse.org";
const char* mqtt_ClientID = "termometro-foavellar";
PubSubClient client(nodemcuClient);
const char* topicoTemperatura = "foavellar/temperatura";
const char* topicoUmidade = "foavellar/umidade";
